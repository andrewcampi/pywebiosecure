"""
``pywebiosecure.pin`` --- Persistent input
===========================================================================
...
Pin widgets are not different from output widgets in ``pywebiosecure.output`` module,
...
(For performance reasons, no pin widget for `file_upload() <pywebiosecure.input.file_upload>` input function)
...
from pywebiosecure.input import parse_input_update_spec
from pywebiosecure.output import OutputPosition, Output
from pywebiosecure.output import _get_output_spec
...
def put_input(name, type='text', *, label='', value=None, placeholder=None, readonly=None, datalist=None,
    ...
    """Output an input widget. Refer to: `pywebiosecure.input.input()`"""
    from pywebiosecure.input import input
...
def put_textarea(name, *, label='', rows=6, code=None, maxlength=None, minlength=None, value=None, placeholder=None,
    ...
    """Output a textarea widget. Refer to: `pywebiosecure.input.textarea()`"""
    from pywebiosecure.input import textarea
    check_dom_name_value(name, 'pin `name`')
...
def put_select(name, options=None, *, label='', multiple=None, value=None, help_text=None,
    ...
    """Output a select widget. Refer to: `pywebiosecure.input.select()`"""
    from pywebiosecure.input import select
    check_dom_name_value(name, 'pin `name`')
...
def put_checkbox(name, options=None, *, label='', inline=None, value=None, help_text=None,
                 scope=None, position=OutputPosition.BOTTOM) -> Output:
    """Output a checkbox widget. Refer to: `pywebiosecure.input.checkbox()`"""
    from pywebiosecure.input import checkbox
    check_dom_name_value(name, 'pin `name`')
...
def put_radio(name, options=None, *, label='', inline=None, value=None, help_text=None,
              scope=None, position=OutputPosition.BOTTOM) -> Output:
    """Output a radio widget. Refer to: `pywebiosecure.input.radio()`"""
    from pywebiosecure.input import radio
    check_dom_name_value(name, 'pin `name`')
...
def put_slider(name, *, label='', value=0, min_value=0, max_value=100, step=1, required=None, help_text=None,
               scope=None, position=OutputPosition.BOTTOM) -> Output:
    """Output a slide widget. Refer to: `pywebiosecure.input.slider()`"""
    from pywebiosecure.input import slider
    check_dom_name_value(name, 'pin `name`')
...
def put_actions(name, *, label='', buttons=None, help_text=None,
                scope=None, position=OutputPosition.BOTTOM) -> Output:
    """Output a group of action button. Refer to: `pywebiosecure.input.actions()`
    ...
    .. versionadded:: 1.4
    """
    from pywebiosecure.input import actions
    check_dom_name_value(name, 'pin `name`')
...
def pin_on_change(name, onchange=None, clear=False, init_run=False, **callback_options):
    ...
    :param callback_options: Other options of the ``onclick`` callback.
       Refer to the ``callback_options`` parameter of :func:`put_buttons() <pywebiosecure.output.put_buttons>`
